      ...
      <main>
        <section className="bg-gradient-to-br from-gray-900 to-blue-950 text-white py-28 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              End-to-end web development services designed to help your business scale and succeed online.
            </p>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            {loading ? (
              ...
              <p className="text-center text-gray-400 py-20 text-lg">No services available yet.</p>
            ) : (
                      ...
                      <ul className="space-y-2">
                        {service.features.map((f, i) => (
                          <li key={i} className="flex items-center gap-2 text-sm text-gray-600">
                            <FiCheckCircle className="text-green-500 flex-shrink-0" /> {f}
                          </li>
                        ))}
                      </ul>
                    )}
        ...
        <section className="py-20 px-6 bg-blue-600 text-white text-center">
          <div className="max-w-xl mx-auto">
            ...
            <p className="text-blue-100 mb-8">Let's discuss your project requirements.</p>
            <Link href="/contact" className="bg-white text-blue-600 px-8 py-3 rounded-xl font-bold hover:bg-blue-50 transition inline-block">
              Talk to Us
            </Link>
          </div>
        </section>
