        ...
        <section className="bg-gradient-to-br from-gray-900 to-blue-950 text-white py-28 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-300">
              A showcase of real-world projects we've designed, built, and deployed.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filtered.map(item => (
                  <div key={item._id}
                    className="rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                    {/* Image */}
