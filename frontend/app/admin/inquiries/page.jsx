          ...
          <div className="flex gap-6">
            ...
            <div className="flex-1 space-y-3">
              {loading ? (
                ...
                <div key={inq._id}
                  onClick={() => { setSelected(inq); updateStatus(inq._id, inq.status === 'new' ? 'read' : inq.status); }}
                  className={`bg-white rounded-xl shadow-sm p-5 cursor-pointer hover:shadow-md transition border-l-4 ${
                    ...
                    'border-green-500'
                  } ${selected?._id === inq._id ? 'ring-2 ring-blue-300' : ''}`}>
                  <div className="flex items-start justify-between">
                    ...
                    <div className="ml-4 text-right flex-shrink-0">
                      ...
                      <button onClick={(e) => { e.stopPropagation(); handleDelete(inq._id); }}
