...
const initialForm = { name: '', email: '', phone: '', date: '', time: '', topic: '' };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-6">
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center max-w-md w-full">
            ...
            <p className="text-gray-500 mb-2">
              Thanks <span className="font-semibold text-gray-700">{form.name}</span>! Your meeting request
              has been submitted.
            </p>
        ...
        <section className="py-24 px-6 bg-gray-50">
          <div className="max-w-xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-4 mb-10">
              {[
                { icon: '📝', label: 'Fill the Form'     },
                { icon: '📅', label: 'Pick a Time Slot'  },
                { icon: '✅', label: 'Get Confirmation'  },
              ].map(s => (
                <div key={s.label} className="text-center bg-white rounded-xl p-4 shadow-sm">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-600 mb-1 flex items-center gap-1">
                      <FiClock size={14} /> Preferred Time
                    </label>
                ...
                <input placeholder="Meeting Topic / Your Project Idea" value={form.topic} onChange={set('topic')}
                  className="input-field" />
